...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ModelFile :  IEquatable<ModelFile>, IValidatableObject
    {
        /// <summary>
        ...
        public ModelFile(Guid? id = default(Guid?), string name = default(string), string link = default(string))
        {
            this.Id = id;
            this.Name = name;
            this.Link = link;
